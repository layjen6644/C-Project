...
void writeFile(const char* logLine);
void readFile();
// Main program
int main()
{
	...
	printf("\n Previous entries: \n");
	readFile(); //Calls readFile function, displays log file
...
void firstCalculation()  //addition
{
	...
	writeFile(logLine); //calls writeLog function and writes string into file
}
...
void secondCalculation()  //subtraction
{
	...
	writeFile(logLine); //calls writeLog function, writes string into file
}
...
void writeFile(const char* logLine) //write to log file
{
...
void readFile() //read from log file
{
	int ch;
